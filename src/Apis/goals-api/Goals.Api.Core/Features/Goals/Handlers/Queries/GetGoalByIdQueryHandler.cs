...
internal sealed class GetGoalByIdQueryHandler(
    ...
    IQueryHandler<GetGoalByIdQuery, GoalResponse>
{
    ...
    public override async Task<GoalResponse> ExecuteAsync(GetGoalByIdQuery query, CancellationToken token = default)
    {
