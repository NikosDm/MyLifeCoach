...
internal sealed class GetGoalTypesQueryHandler(
    ...
    IQueryHandler<GetGoalTypesQuery, IReadOnlyList<GoalTypeResponse>>
{
    ...
    public override async Task<IReadOnlyList<GoalTypeResponse>> ExecuteAsync(GetGoalTypesQuery query, CancellationToken token = default)
    {
